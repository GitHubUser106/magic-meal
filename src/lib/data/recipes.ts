    ...
    recipes: [
      ...
      },
      {
        ...
        instructions: [
          ...
          "Add 1 cup instant rice to the dish. Stir into the soup mixture.",
          "Place 2 chicken breasts on top. Season chicken with salt, pepper, garlic powder.",
          "Cover tightly with foil. Bake 30-35 minutes until chicken is cooked through.",
          "Let rest 5 minutes. The rice absorbs the creamy soup and it's incredible.",
        ],
      },
    ],
  },
