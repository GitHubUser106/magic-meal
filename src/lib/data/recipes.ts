    ...
    pairings: [
      {
        ...
        emoji: "🍗",
        ingredients: ["2 chicken breasts (about 1 lb)", "instant/minute rice", "frozen broccoli"],
      ...
      },
      {
        ...
        emoji: "🌮",
        ingredients: ["1 chicken breast", "flour tortillas (large)", "shredded Mexican cheese blend"],
      ...
      },
      {
        ...
        emoji: "🍝",
        ingredients: ["2 chicken breasts (about 1 lb)", "pasta (penne or rotini)", "jarred marinara sauce"],
      ...
      },
      {
        ...
        emoji: "🥪",
        ingredients: ["2-3 chicken breasts (about 1-1.5 lbs)", "BBQ sauce (bottle)", "hamburger or brioche buns"],
      ...
      },
      {
        ...
        emoji: "\u{1F36F}",
        ingredients: ["1 chicken breast", "honey", "garlic (3-4 cloves)"],
        cookTime: "15 minutes",
        difficulty: "easy",
        equipment: ["skillet"],
        servings: 2,
      ...
      },
      {
        ...
        instructions: [
          ...
          "Warm each tortilla in the microwave for 10 seconds so it's pliable and won't crack when folded.",
      ...
      },
      {
        ...
        emoji: "\u{1F35D}",
        ingredients: ["2 chicken breasts (about 1 lb)", "cream cheese (4 oz block)", "pasta"],
        cookTime: "20 minutes",
        difficulty: "easy",
    ...
    pairings: [
      {
        ...
        emoji: "🍝",
        ingredients: ["1 lb ground beef", "spaghetti", "jarred marinara sauce"],
      ...
      },
      {
        ...
        emoji: "🌮",
        ingredients: ["1 lb ground beef", "taco shells or flour tortillas", "shredded cheddar or Mexican blend cheese"],
      ...
      },
      {
        ...
        emoji: "🍔",
        ingredients: ["1 lb ground beef", "hamburger buns", "American cheese slices or cheddar slices"],
      ...
      },
      {
        ...
        emoji: "🍚",
        ingredients: ["1 lb ground beef", "instant/minute rice", "frozen mixed vegetables"],
      ...
      },
      {
        ...
        emoji: "\u{1F354}",
        ingredients: ["1 lb ground beef", "ketchup", "hamburger buns"],
        cookTime: "15 minutes",
        difficulty: "easy",
        equipment: ["skillet"],
        servings: 4,
        instructions: [
          ...
          "While the sauce simmers, toast the buns in a separate skillet (or the same one after removing the meat) for 30 seconds per side.",
          "Spoon onto toasted buns. Eat with napkins \u2014 you'll need them.",
        ],
        proTips: [
      ...
      },
      {
        ...
        emoji: "\u{1FAD4}",
        ingredients: ["1 lb ground beef", "tortillas", "shredded cheese"],
        cookTime: "15 minutes",
        difficulty: "easy",
        equipment: ["skillet"],
        servings: 3,
      ...
      },
      {
        ...
        emoji: "\u{1F354}",
        ingredients: ["1 lb ground beef", "instant rice", "cheese slices"],
        cookTime: "15 minutes",
        difficulty: "easy",
      ...
      },
      {
        ...
        emoji: "\u{1F32F}",
        ingredients: ["1 lb ground beef", "canned refried beans", "tortillas"],
        cookTime: "15 minutes",
        difficulty: "easy",
        equipment: ["skillet"],
        servings: 4,
    ...
    pairings: [
      {
        ...
        emoji: "🍳",
        tags: ["vegetarian"],
        ingredients: ["2 eggs", "sandwich bread or English muffins", "American cheese slices or cheddar slices"],
      ...
      },
      {
        ...
        emoji: "🌯",
        tags: ["vegetarian"],
        ingredients: ["4 eggs", "flour tortillas (large)", "shredded Mexican cheese blend"],
      ...
      },
      {
        ...
        emoji: "🍚",
        tags: ["vegetarian"],
        ingredients: ["2-3 eggs", "instant rice (or leftover rice)", "frozen peas and carrots mix"],
      ...
      },
      {
        ...
        emoji: "🥞",
        tags: ["vegetarian"],
        ingredients: ["2 eggs", "ripe bananas", "quick oats"],
      ...
      },
      {
        ...
        emoji: "\u{1F954}",
        ingredients: ["3-4 eggs", "frozen hash browns", "shredded cheese"],
        cookTime: "15 minutes",
        difficulty: "easy",
        equipment: ["skillet"],
        servings: 2,
      ...
      },
      {
        ...
        emoji: "\u{1F95A}",
        ingredients: ["2 eggs", "shredded cheese", "2-3 slices deli ham (or any deli meat)"],
        cookTime: "5 minutes",
        difficulty: "beginner",
      ...
      },
      {
        ...
        emoji: "\u{1F32E}",
        ingredients: ["4 eggs", "tortillas (small)", "shredded cheese"],
        cookTime: "10 minutes",
        difficulty: "beginner",
        equipment: ["skillet"],
        servings: 2,
      ...
      },
      {
        ...
        emoji: "\u{1F373}",
        ingredients: ["3-4 eggs", "canned diced tomatoes (or Rotel)", "bread"],
        cookTime: "15 minutes",
        difficulty: "easy",
        equipment: ["skillet with lid"],
        servings: 2,
      ...
      },
      {
        ...
        emoji: "\u{1F95E}",
        ingredients: ["2 eggs", "ripe banana", "butter"],
        cookTime: "10 minutes",
        difficulty: "easy",
    ...
    pairings: [
      {
        ...
        emoji: "🥪",
        ingredients: ["2 cans (5 oz each) tuna", "sandwich bread", "celery or lettuce"],
      ...
      },
      {
        ...
        emoji: "🍝",
        ingredients: ["2 cans (5 oz each) tuna", "pasta (elbow macaroni or rotini)", "frozen peas"],
      ...
      },
      {
        ...
        emoji: "🧀",
        ingredients: ["1-2 cans (5 oz each) tuna", "Ritz-style crackers or tortilla chips", "shredded cheddar cheese"],
      ...
      },
      {
        ...
        emoji: "\u{1F9C0}",
        ingredients: ["1 can (5 oz) tuna", "bread", "cheese slices"],
        cookTime: "10 minutes",
        difficulty: "easy",
      ...
      },
      {
        ...
        emoji: "\u{1F35A}",
        ingredients: ["1 can (5 oz) tuna", "instant rice", "sriracha (or any hot sauce)"],
        cookTime: "10 minutes",
        difficulty: "easy",
        equipment: ["pot", "bowl"],
        servings: 1,
      ...
      },
      {
        ...
        recipeName: "Tuna Mac",
        emoji: "\u{1F9C0}",
        ingredients: ["1 can (5 oz) tuna", "boxed mac & cheese", "frozen peas"],
        cookTime: "15 minutes",
        difficulty: "easy",
        equipment: ["pot"],
        servings: 3,
    ...
    pairings: [
      {
        ...
        emoji: "🥓",
        ingredients: ["4-6 strips bacon", "2 eggs", "American cheese slices or cheddar"],
      ...
      },
      {
        ...
        emoji: "🍝",
        ingredients: ["6 strips bacon", "spaghetti or any long pasta", "parmesan cheese (grated, from the green can is fine)"],
      ...
      },
      {
        ...
        emoji: "🥪",
        ingredients: ["6-8 strips bacon", "sandwich bread (white, toasted)", "tomato"],
      ...
      },
      {
        ...
        emoji: "\u{1F373}",
        ingredients: ["4-5 strips bacon", "2 eggs", "instant rice (cooked)"],
        cookTime: "15 minutes",
        difficulty: "easy",
        equipment: ["skillet"],
        servings: 2,
      ...
      },
      {
        ...
        emoji: "\u{1F35D}",
        ingredients: ["5-6 strips bacon", "cream cheese (4 oz block)", "pasta"],
        cookTime: "20 minutes",
        difficulty: "easy",
        equipment: ["pot", "skillet"],
        servings: 2,
      ...
      },
      {
        ...
        recipeName: "BLT Wrap",
        emoji: "\u{1F96C}",
        ingredients: ["4-5 strips bacon", "tortillas", "tomato"],
        cookTime: "10 minutes",
        difficulty: "beginner",
  ...
  },
  {
    ...
    pairings: [
      ...
      },
      {
        ...
        emoji: "\u{1F95C}",
        ingredients: ["1 block (14 oz) firm tofu", "instant ramen noodles (discard flavor packet)", "peanut butter"],
        cookTime: "15 minutes",
        difficulty: "easy",
        equipment: ["pot", "skillet"],
        servings: 2,
      ...
      },
      {
        ...
        emoji: "\u{1F966}",
        ingredients: ["1 block (14 oz) firm tofu", "frozen broccoli", "instant rice"],
        cookTime: "20 minutes",
        difficulty: "easy",
        equipment: ["skillet", "pot"],
        servings: 2,
    ...
    recipes: [
      {
        ...
        emoji: "🍜",
        ingredients: ["instant ramen", "1 egg", "green onions"],
        cookTime: "8 minutes",
        difficulty: "beginner",
        equipment: ["pot"],
        servings: 1,
      ...
      },
      {
        ...
        emoji: "\u{1F35C}",
        ingredients: ["instant ramen", "1 egg", "butter"],
        cookTime: "8 minutes",
        difficulty: "beginner",
        equipment: ["pot"],
        servings: 1,
      ...
      },
      {
        ...
        emoji: "\u{1F9C0}",
        ingredients: ["instant ramen", "American cheese slice", "1 egg"],
        cookTime: "8 minutes",
        difficulty: "beginner",
        equipment: ["pot"],
        servings: 1,
  ...
  },
  {
    ...
    recipes: [
      ...
      },
      {
        ...
        emoji: "🍲",
        ingredients: ["Campbell's cream of mushroom soup", "1 can (12.5 oz) canned chicken (or 1 cup leftover chicken)", "instant rice"],
        cookTime: "15 minutes",
        difficulty: "easy",
        equipment: ["pot with lid"],
        servings: 2,
    ...
    recipes: [
      {
        ...
        emoji: "🌭",
        ingredients: ["boxed mac & cheese", "3-4 hot dogs"],
        cookTime: "15 minutes",
        difficulty: "beginner",
        equipment: ["pot", "skillet"],
        servings: 2,
      ...
      },
      {
        ...
        emoji: "🧀",
        ingredients: ["boxed mac & cheese", "frozen broccoli", "1 can (12.5 oz) chicken (or 1 cup shredded rotisserie chicken)"],
        cookTime: "18 minutes",
        difficulty: "beginner",
        equipment: ["pot"],
        servings: 2,
