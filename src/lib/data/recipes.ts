...
export const PROTEINS: Protein[] = [
  {
    ...
    pairings: [
      ...
      },
      {
        ...
        emoji: "\u{1F36F}",
        ingredients: ["chicken breast", "honey", "soy sauce"],
        cookTime: "15 minutes",
        difficulty: "easy",
        equipment: ["skillet"],
        servings: 2,
        instructions: [
          ...
          "Mix 3 tablespoons honey with 2 tablespoons soy sauce in a small bowl.",
          "Pour the honey-soy mixture over the chicken. Stir and cook for 2 more minutes until the sauce gets sticky and coats everything.",
        ],
        proTips: [
    ...
    pairings: [
      {
        ...
        emoji: "\u{1F962}",
        ingredients: ["firm tofu (1 block)", "instant rice", "soy sauce"],
        cookTime: "20 minutes",
        difficulty: "easy",
        equipment: ["skillet"],
        servings: 2,
        ...
        instructions: [
          ...
          "Once tofu is crispy on a few sides, pour in 2-3 tablespoons of soy sauce. Toss to coat. Serve over rice.",
        ],
        proTips: [
...
export const DOCTOR_IT_UP_BASES: DoctorItUpBase[] = [
  {
    ...
    recipes: [
      ...
      },
      {
        ...
        emoji: "\u{1F35C}",
        ingredients: ["instant ramen", "frozen stir-fry vegetables", "soy sauce"],
        cookTime: "10 minutes",
        difficulty: "easy",
        equipment: ["skillet", "pot"],
        servings: 1,
        instructions: [
          ...
          "Heat oil in a skillet over high heat. Add frozen vegetables. Cook for 3 minutes, stirring often.",
          "Add the drained noodles to the skillet. Sprinkle half the seasoning packet and a splash of soy sauce.",
          "Stir-fry everything together for 2-3 minutes until noodles start to get a little crispy on the edges.",
        ],
        proTips: [
