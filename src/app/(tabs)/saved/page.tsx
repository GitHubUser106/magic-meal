    ...
    <div className="px-4 py-5 max-w-lg mx-auto">
      ...
      {savedRecipes.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-16 text-center">
          ...
          <h2 className="text-xl font-semibold mb-1">No saved recipes yet</h2>
          <p className="text-base text-muted-foreground mb-6 max-w-[240px]">
            Tap the heart on any recipe to save it here
          </p>
          <Link
            href="/cook"
            className="px-5 py-2.5 rounded-full bg-amber-500 text-white font-medium text-base hover:bg-amber-600 transition-colors min-h-[44px] flex items-center"
          >
            Start cooking &rarr;
          </Link>
        </div>
